...
place(subgroup, "tiny-armor-mk1", "f")
place(subgroup, "tiny-armor-mk2", "g")
place(subgroup, "power-armor", "h")
place(subgroup, "power-armor-mk2", "i")
place(subgroup, "bob-power-armor-mk3", "j")
place(subgroup, "bob-power-armor-mk4", "k")
place(subgroup, "bob-power-armor-mk5", "l")
...
place(subgroup, "yi_cannon_shell", "g")
place(subgroup, "y_ammo_shell_recipe", "g-r1")
...
place(subgroup, "yi_artillery_shell", "f")
place(subgroup, "y_ammo_artillery_recipe", "f-r1")
place(subgroup, "artillery-shell-nuclear", "g")
place(subgroup, "artillery-shell-thermonuclear", "h")
...
place(subgroup, "y_wood_wall", "a")
place(subgroup, "y_wood_wall_recipe", "a-r1")
place(subgroup, "stone-wall", "b")
place(subgroup, "plaswall", "c")
place(subgroup, "reinforced-wall", "d")
place(subgroup, "concrete-wall", "e")
place(subgroup, "steel-wall", "f")
place(subgroup, "gate", "g")
place(subgroup, "reinforced-gate", "h")
