...
place(subgroup, "wood-sawing", "a-r1")
place(subgroup, "y_unlimited_wood", "a-r2")
place(subgroup, "synthetic-wood", "b")
place(subgroup, "cellulose-fiber", "c")
place(subgroup, "cellulose-fiber-raw-wood", "c-r1")
place(subgroup, "wood-pellets", "d")
place(subgroup, "wood-bricks", "e")
...
place(subgroup, "y-crush-yres1", "b")
place(subgroup, "y-crush-unicomp-raw-recipe", "b-r1")
place(subgroup, "y-crush-blue_whead-recipe", "b-r2")

subgroup = "ts-mat-F7"
place(subgroup, "y-res2", "a")
place(subgroup, "angelsore-chunk-mix-yi2-processing", "a-r1")
place(subgroup, "y-crush-yres2", "b")
place(subgroup, "y-crush-fuel-raw-recipe", "b-r1")
...
place(subgroup, "20%-uranium", "l")
place(subgroup, "clowns-centrifuging-20%-ore", "l-r1")
place(subgroup, "clowns-centrifuging-20%-hexafluoride", "l-r2")
place(subgroup, "35%-uranium", "m")
place(subgroup, "clowns-centrifuging-35%", "m-r1")
place(subgroup, "45%-uranium", "n")
place(subgroup, "clowns-centrifuging-45%", "n-r1")
place(subgroup, "55%-uranium", "o")
place(subgroup, "clowns-centrifuging-55%", "o-r1")
place(subgroup, "65%-uranium", "p")
place(subgroup, "clowns-centrifuging-65%", "p-r1")
place(subgroup, "70%-uranium", "q")
place(subgroup, "clowns-centrifuging-70%", "q-r1")
place(subgroup, "75%-uranium", "r")
place(subgroup, "clowns-centrifuging-75%", "r-r1")
...
place(subgroup, "gas-carbon-dioxide", "ac")
place(subgroup, "carbon-separation-2", "ac-r1")
place(subgroup, "gas-carbon-monoxide", "da")
place(subgroup, "carbon-separation-1", "da-r1")
