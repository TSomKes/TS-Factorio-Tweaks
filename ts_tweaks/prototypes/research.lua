...
place(subgroup, "cpy", "e")
place(subgroup, "momo-cpy-N4", "e-r1")
place(subgroup, "green-sci", "f")
place(subgroup, "momo-green-sci-N4", "f-r1")
place(subgroup, "pre-cyan-sci", "g")
place(subgroup, "momo-pre-cyan-sci-N4", "g-r1")
place(subgroup, "cyan-sci", "h")
place(subgroup, "momo-cyan-sci-N3", "h-r1")
place(subgroup, "dark-chip", "i")
place(subgroup, "momo-dark-chip-N4", "i-r1")
place(subgroup, "b2", "j")
place(subgroup, "momo-b2-N3", "j-r1")
place(subgroup, "b3", "k")
place(subgroup, "momo-b3-N3", "k-r1")
place(subgroup, "b4", "l")
place(subgroup, "momo-b4-N3", "l-r1")
place(subgroup, "b5", "m")
place(subgroup, "momo-b5-N3", "m-r1")
place(subgroup, "atc", "n")
place(subgroup, "momo-atc-N1", "n-r1")
...
place(subgroup, "red-sci", "b")
place(subgroup, "momo-red-sci-N5", "b-r1")
place(subgroup, "b1", "c")
place(subgroup, "momo-b1-N3", "c-r1")
place(subgroup, "sct-2", "d")
place(subgroup, "momo-sct-2-N1", "d-r1")
place(subgroup, "sct-t2-wafer-stamp", "e")
place(subgroup, "sct-t2-micro-wafer", "f")
place(subgroup, "sct-t2-microcircuits", "g")
place(subgroup, "sct-t2-instruments", "h")
place(subgroup, "sct-t2-reaction-nodes", "i")
